...
_PQR_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train':5011, # number of file in the train folder
        'trainval': 9963,
        'val': 4952,
    },
...
# _WL_SEG_INFORMATION = DatasetDescriptor(
#     splits_to_sizes={
#         'train':3682, # number of file in the train folder
#         'trainval': 4910,
#         'val': 1228,
#     },
#     num_classes=61, # number of classes in your dataset(black+59+ignore)
#     ignore_label=255, # white edges that will be ignored to be class
# )
...
_WL_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train':5502, # number of file in the train folder
        'trainval': 6878,
        'val': 1376,
    },
    num_classes=5, # number of classes in your dataset(black+59+ignore)
    ignore_label=255, # white edges that will be ignored to be class
)
...
_DATASETS_INFORMATION = {
    ...
    'pascal_voc_seg_matting': _PASCAL_VOC_SEG_MATTING_INFORMATION,
    'ade20k': _ADE20K_INFORMATION,
    'pqr': _PQR_SEG_INFORMATION,
    'wl': _WL_SEG_INFORMATION
}
