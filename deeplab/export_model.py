...
flags.DEFINE_string('checkpoint_path', 'F:/Jupyter/models-master/research/deeplab/datasets/PQR/exp/train_on_trainval_set/train/model.ckpt-30000', 'Checkpoint path')

flags.DEFINE_string('export_path','F:/Jupyter' ,
