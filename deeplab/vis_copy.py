...
import sys
#sys.path.append(r'F:\Jupyter\models-master\research')
#sys.path.append(r'F:\Jupyter\models-master\research\slim')
...
flags.DEFINE_string('vis_logdir', '/home/ai/wl_nlp/models-master/research/deeplab/datasets/PQR/exp/train_on_trainval_set/vis', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir','/home/ai/wl_nlp/models-master/research/deeplab/datasets/PQR/exp/train_on_trainval_set/train', 'Directory of model checkpoints.')
...
flags.DEFINE_string('dataset_dir', '/home/ai/wl_nlp/models-master/research/deeplab/datasets/PQR/tfrecord', 'Where the dataset reside.')
...
def _process_batch(sess, original_images, semantic_predictions, image_names,
  ...
  for i in range(num_image):
    image_name = image_names[i].decode()
    image_name_prediction = image_name + '_pred'
    ...
    #     add_colormap=False)
    save_annotation.save_annotation(
        original_image, save_dir, image_name,
        add_colormap=False)
    ...
    save_annotation.save_annotation(
        crop_semantic_prediction, save_dir,
        image_name_prediction, add_colormap=True,
        colormap_type=FLAGS.colormap_type)
...
def main(unused_argv):
  ...
  with g.as_default():
    ...
    if FLAGS.min_resize_value and FLAGS.max_resize_value:
      ...
      # predictions = tf.squeeze(
      #     tf.image.resize_images(predictions,
      #                            [tf.squeeze(samples[common.HEIGHT]), tf.squeeze(samples[common.WIDTH])],
      #                            method=tf.image.ResizeMethod.NEAREST_NEIGHBOR))
