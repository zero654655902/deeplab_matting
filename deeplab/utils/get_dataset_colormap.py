...
_PASCAL = 'pascal'
_WL = 'wl'
_PASCAL_VOC_SEG_MATTING_INFORMATION = 'pascal_voc_seg_matting'
...
_DATASET_MAX_ENTRIES = {
    ...
    _PASCAL: 256,
    _WL: 5,
    _PASCAL_VOC_SEG_MATTING_INFORMATION: 2
}
...
def create_wl_label_colormap():
  """Creates a label colormap used in PASCAL VOC segmentation benchmark.

  Returns:
    A colormap for visualizing segmentation results.
  """
  colormap = np.zeros((_DATASET_MAX_ENTRIES[_WL], 3), dtype=int)
  ind = np.arange(_DATASET_MAX_ENTRIES[_WL], dtype=int)
...
def create_matting_label_colormap():
  ...
  Returns:
    A colormap for visualizing segmentation results.
  """
  colormap = np.zeros((_DATASET_MAX_ENTRIES[_PASCAL_VOC_SEG_MATTING_INFORMATION], 3), dtype=int)
  ind = np.arange(_DATASET_MAX_ENTRIES[_PASCAL_VOC_SEG_MATTING_INFORMATION], dtype=int)
...
def create_label_colormap(dataset=_PASCAL):
  ...
  if dataset == _ADE20K:
    ...
    return create_wl_label_colormap()
  elif dataset == _PASCAL_VOC_SEG_MATTING_INFORMATION:
